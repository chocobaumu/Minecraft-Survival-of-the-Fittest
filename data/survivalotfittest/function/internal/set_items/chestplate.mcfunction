...
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 1..10 if score #World Choco.SotF.Tick.0 matches 24000.. run item replace entity @s armor.chest with leather_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 11..20 if score #World Choco.SotF.Tick.0 matches 120000.. run item replace entity @s armor.chest with chainmail_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 21..25 if score #World Choco.SotF.Tick.0 matches 120000.. run item replace entity @s armor.chest with iron_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 26..30 if score #World Choco.SotF.Tick.0 matches 144000.. run item replace entity @s armor.chest with iron_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 31..40 if score #World Choco.SotF.Tick.0 matches 192000.. run item replace entity @s armor.chest with golden_chestplate[enchantments={levels:{"minecraft:blast_protection":4,"minecraft:thorns":3,"minecraft:unbreaking":3}}]
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 41..45 if score #World Choco.SotF.Tick.0 matches 240000.. run item replace entity @s armor.chest with diamond_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 46..50 if score #World Choco.SotF.Tick.0 matches 264000.. run item replace entity @s armor.chest with diamond_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 51..55 if score #World Choco.SotF.Tick.0 matches 720000.. run item replace entity @s armor.chest with netherite_chestplate
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 56..60 if score #World Choco.SotF.Tick.0 matches 744000.. run item replace entity @s armor.chest with netherite_chestplate