...
execute unless items entity @s armor.chest * if score @s Choco.SotF.Items.Random matches 31..40 if score #World Choco.SotF.Tick.0 matches 192000.. run item replace entity @s armor.chest with golden_chestplate[enchantments={"minecraft:blast_protection":4,"minecraft:thorns":3,"minecraft:unbreaking":3}] 1
