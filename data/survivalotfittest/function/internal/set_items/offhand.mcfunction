...
execute if score @s Choco.SotF.Items.Random matches 41..45 if score #World Choco.SotF.Tick.0 matches 216000.. run item replace entity @s weapon.offhand with lava_bucket
execute if score @s Choco.SotF.Items.Random matches 46..50 if score #World Choco.SotF.Tick.0 matches 240000.. run item replace entity @s weapon.offhand with lava_bucket
...
execute if score @s Choco.SotF.Items.Random matches 41..45 if score #World Choco.SotF.Tick.0 matches 216000.. run scoreboard players set @s Choco.SotF.Items.Offhand 4
execute if score @s Choco.SotF.Items.Random matches 46..50 if score #World Choco.SotF.Tick.0 matches 240000.. run scoreboard players set @s Choco.SotF.Items.Offhand 4
...
execute if entity @s[type=pillager] if score @s Choco.SotF.Items.Random matches 1..10 if score #World Choco.SotF.Tick.0 matches 24000.. run scoreboard players set @s Choco.SotF.Items.Offhand 12
