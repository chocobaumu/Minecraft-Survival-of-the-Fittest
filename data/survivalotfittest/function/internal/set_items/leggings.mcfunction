...
execute unless items entity @s armor.legs * if score @s Choco.SotF.Items.Random matches 31..40 if score #World Choco.SotF.Tick.0 matches 192000.. run item replace entity @s armor.legs with golden_leggings[enchantments={"minecraft:blast_protection":4,"minecraft:thorns":3,"minecraft:unbreaking":3}] 1
