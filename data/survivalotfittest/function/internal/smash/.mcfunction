...
execute unless block ~ ~-1 ~ #survivalotfittest:can_through if entity @n[type=item,distance=..1] align xyz positioned ~0.5 ~0.05 ~0.5 run summon item_display ~ ~-0.25 ~ {teleport_duration:2,Tags:["Choco.SotF.Smash","Choco.SotF.Temp"],brightness:{sky:15,block:0},item:{id:"minecraft:air",count:1}}
