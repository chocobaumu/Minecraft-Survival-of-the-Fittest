...
execute if score @s Choco.SotF.Drill.Click matches 0 if predicate survivalotfittest:inventory_gasoline if score @s Choco.SotF.Drill.Gasoline matches ..499 run function survivalotfittest:item/drill/reload