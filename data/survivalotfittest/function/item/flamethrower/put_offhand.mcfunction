...
execute if score @s Choco.SotF.Flamethrower.Click matches 0 if predicate survivalotfittest:inventory_gasoline if score @s Choco.SotF.Flamethrower.Gasoline matches ..499 run function survivalotfittest:item/flamethrower/reload