...
item replace entity @s weapon.mainhand with recovery_compass[item_model="survivalotfittest:activated_guardian_eye",item_name=["アイケース",{"color":"#2288FF","italic":false,"text":" [潮汐の眼]"}],rarity="epic",custom_data={SotF.Category:ActivatedGuardianEye,SotF:ActivatedTidalEye},lore=[[{"bold":true,"color":"gold","italic":false,"text":"マジカル・タイダル"},{"bold":false,"color":"dark_gray","italic":false,"text":"(右クリック)"}],{"color":"gray","italic":false,"text":"スニークをしていない場合、対象を自身のもとへ引き寄せる。"},{"color":"gray","italic":false,"text":"スニークをしている場合、目線先に跳躍する。"},[{"color":"dark_gray","italic":false,"text":"クールタイム:"},{"color":"dark_aqua","italic":false,"text":" 3s"},{"color":"dark_gray","italic":false,"text":"(アイケース間で共有)"}]," "],consumable={consume_seconds:2147483647},!max_stack_size] 1