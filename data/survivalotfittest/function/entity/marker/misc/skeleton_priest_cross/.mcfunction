...
execute if score @s Choco.SotF.Tick.0 matches 1 run function survivalotfittest:entity/marker/misc/skeleton_priest_cross/init
...
execute at @s if score @s Choco.SotF.Tick.0 matches 10 run playsound block.bell.use hostile @a ~ ~ ~ 1 0.5
execute at @s if score @s Choco.SotF.Tick.0 matches 40 run playsound block.bell.use hostile @a ~ ~ ~ 1.5 0.5
execute at @s if score @s Choco.SotF.Tick.0 matches 70 run playsound block.bell.use hostile @a ~ ~ ~ 2 0.5

execute at @s if score @s Choco.SotF.Tick.0 matches 10 run playsound block.bell.resonate hostile @a ~ ~ ~ 1 0.5
execute at @s if score @s Choco.SotF.Tick.0 matches 40 run playsound block.bell.resonate hostile @a ~ ~ ~ 1.5 0.75
execute at @s if score @s Choco.SotF.Tick.0 matches 70 run playsound block.bell.resonate hostile @a ~ ~ ~ 2 1
...
execute at @s if score @s Choco.SotF.Tick.0 matches 111.. rotated as @s run function survivalotfittest:entity/marker/misc/skeleton_priest_cross/vanish with storage sotf:priest_cross

execute at @s as @e[tag=Choco.SotF.SkeletonLegion,distance=..24] at @s run function survivalotfittest:entity/marker/misc/skeleton_priest_cross/mark