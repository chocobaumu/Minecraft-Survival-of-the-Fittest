...
execute if score @s Choco.SotF.ScoreStorage.1 matches 3.. run scoreboard players set @s Choco.SotF.ScoreStorage.1 0
execute if score @s Choco.SotF.ScoreStorage.1 matches 1 if score @s Choco.SotF.Tick.0 matches 2..50 rotated ~ ~90 run function survivalotfittest:particle/chocobaumu/punishment_impact
...
execute if score @s Choco.SotF.ScoreStorage.1 matches 2 if score @s Choco.SotF.Tick.0 matches 50..150 rotated ~ ~90 run function survivalotfittest:particle/chocobaumu/laser_beam_impact
