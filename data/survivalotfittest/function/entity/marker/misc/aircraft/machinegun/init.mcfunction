execute store result score @s Choco.SotF.ScoreStorage.1 run random value -2..2
execute store result score @s Choco.SotF.ScoreStorage.2 run random value -2..2
