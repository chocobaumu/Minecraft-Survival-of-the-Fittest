...
summon creeper ~ ~ ~ {Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,powered:1b,ExplosionRadius:4b,Fuse:0,Tags:["Choco.SotF.Custom","Choco.SotF.Explosion"],CustomName:"ロケット"}
