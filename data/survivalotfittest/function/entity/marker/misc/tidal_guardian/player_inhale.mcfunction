...
execute rotated as @n[type=marker,tag=Choco.SotF.Tidal.Tide,tag=Choco.SotF.Player] positioned 0.0 0.0 0.0 run summon marker ^ ^0.1 ^-1 {Tags:["Choco.SotF.PgilinPotion_Direction"]}
