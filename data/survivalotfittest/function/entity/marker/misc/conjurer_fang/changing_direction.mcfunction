...
execute as @e[type=marker,tag=Choco.SotF.UndeadConjurer.Fang.ChangingDirection] at @s facing entity @e[tag= Choco.SotF.Zombie_Target,sort=nearest,limit=1] feet rotated ~ 0 run tp @s ~ ~ ~ ~ ~
...
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 1..180 rotated as @s run tp @s ~ ~ ~ ~-10 0
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches ..-180 rotated as @s run tp @s ~ ~ ~ ~-10 0
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches -179..0 rotated as @s run tp @s ~ ~ ~ ~10 0
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 181.. rotated as @s run tp @s ~ ~ ~ ~10 0