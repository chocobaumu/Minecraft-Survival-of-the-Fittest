...
execute at @s positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=!warden,tag=!Choco.SotF.SculkSoul,tag=Choco.SotF.Mobs,dx=0] at @s run function survivalotfittest:entity/marker/misc/warden/laser/hit
