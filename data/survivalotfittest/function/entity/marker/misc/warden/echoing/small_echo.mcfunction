execute store result score @s Choco.SotF.Random run random value -75..75
...
execute run function survivalotfittest:entity/marker/misc/warden/echoing/small_echo_summon with storage sotf:warden