...
summon area_effect_cloud ~ ~ ~ {WaitTime:0,custom_particle:{type:"snowflake"},Radius:4f,Duration:100,Age:0,potion_contents:{custom_effects:[{id:"minecraft:slowness",amplifier:9,duration:20},{id:"minecraft:weakness",amplifier:9,duration:20},{id:"minecraft:mining_fatigue",amplifier:9,duration:20}]}}
