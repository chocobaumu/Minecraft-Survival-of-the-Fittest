...
effect give @a[gamemode=!spectator,distance=..5.5] instant_health 1 1 true
execute as @a[gamemode=!spectator,distance=..5.5] at @s run particle happy_villager ~ ~0.85 ~ 0.25 0.55 0.25 0.1 10 normal
