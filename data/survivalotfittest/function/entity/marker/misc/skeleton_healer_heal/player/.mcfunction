...
execute if score @s Choco.SotF.Tick.0 matches 1 run function survivalotfittest:entity/marker/misc/skeleton_healer_heal/player/init

execute at @s rotated as @s run tp @s ~ ~ ~ ~5 0

execute at @s if score @s Choco.SotF.Tick.0 matches 1 run function survivalotfittest:entity/marker/misc/skeleton_healer_heal/particle {range:1}
...
execute if score @s Choco.SotF.Tick.0 matches 1.. at @s run playsound entity.experience_orb.pickup hostile @a ~ ~ ~ 1 1

execute if score @s Choco.SotF.Tick.0 matches 20.. run function survivalotfittest:entity/marker/misc/skeleton_healer_heal/player/succeed