...
execute if score @s Choco.SotF.ScoreStorage.0 matches 1.. at @s positioned ~ ~ ~5 unless entity @e[tag=Choco.SotF.SuperNova.Explosion,distance=..0.5] run summon marker ~ ~ ~ {Tags:["Choco.SotF.SuperNova.Explosion"]}
execute if score @s Choco.SotF.ScoreStorage.0 matches 1.. at @s positioned ~ ~ ~-5 unless entity @e[tag=Choco.SotF.SuperNova.Explosion,distance=..0.5] run summon marker ~ ~ ~ {Tags:["Choco.SotF.SuperNova.Explosion"]}
execute at @s run summon creeper ~ ~ ~ {Tags:["Choco.SotF.NotDisplayDamages","Choco.SotF.Custom"],Invulnerable:1b,NoAI:1b,powered:1b,ExplosionRadius:5b,Fuse:0,ignited:1b,CustomName:'{"text":"超新星","color":"dark_aqua","italic":false}'}
