...
#init
execute if score @s Choco.SotF.Tick.0 matches 1 run function survivalotfittest:entity/item_display/wind_chamber/init

scoreboard players set @s Choco.SotF.ScoreStorage.1 6
execute at @s run function survivalotfittest:entity/item_display/wind_chamber/procceed

execute if score @s Choco.SotF.Tick.0 matches 100.. run function survivalotfittest:entity/item_display/wind_chamber/hit
