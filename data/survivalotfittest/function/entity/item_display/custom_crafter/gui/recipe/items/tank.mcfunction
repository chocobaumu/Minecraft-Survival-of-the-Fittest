...
item replace block ~ ~ ~ container.11 with cauldron[custom_data={SotF:GUIItem}] 1
...
item replace block ~ ~ ~ container.20 with recovery_compass[item_name="鋼鉄インゴット",item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_name="タンク",item_model="survivalotfittest:tank",custom_data={SotF:GUIItem},rarity="common"] 1
