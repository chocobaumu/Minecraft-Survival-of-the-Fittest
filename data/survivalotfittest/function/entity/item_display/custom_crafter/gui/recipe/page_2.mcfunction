...
#表示
item replace block ~ ~ ~ container.1 with leather_helmet[item_name="シーサーペントのヘルメット",rarity="uncommon",custom_data={SotF:GUIItem},dyed_color=2831931,tooltip_display={hidden_components:["dyed_color","trim","attribute_modifiers"]},trim={material:"minecraft:diamond",pattern:"minecraft:sentry"}] 1
item replace block ~ ~ ~ container.2 with leather_chestplate[item_name="シーサーペントのチェストプレート",rarity="uncommon",custom_data={SotF:GUIItem},dyed_color=2107435,tooltip_display={hidden_components:["dyed_color","trim","attribute_modifiers"]},trim={material:"minecraft:diamond",pattern:"minecraft:sentry"}] 1
item replace block ~ ~ ~ container.3 with leather_leggings[item_name="シーサーペントのレギンス",rarity="uncommon",custom_data={SotF:GUIItem},dyed_color=2107435,tooltip_display={hidden_components:["dyed_color","trim","attribute_modifiers"]},trim={material:"minecraft:lapis",pattern:"minecraft:sentry"}] 1
item replace block ~ ~ ~ container.4 with leather_boots[item_name="シーサーペントのブーツ",rarity="uncommon",custom_data={SotF:GUIItem},dyed_color=1119511,tooltip_display={hidden_components:["dyed_color","trim","attribute_modifiers"]},trim={material:"minecraft:lapis",pattern:"minecraft:sentry"}] 1
