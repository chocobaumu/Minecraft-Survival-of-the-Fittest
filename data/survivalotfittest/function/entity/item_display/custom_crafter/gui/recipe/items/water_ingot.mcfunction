# レシピ部分
item replace block ~ ~ ~ container.1 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.2 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.3 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.10 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with blue_ice[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
...
item replace block ~ ~ ~ container.20 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.21 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:water_ingot",item_name='"アクアチウムインゴット"',rarity="rare",custom_data={SotF:GUIItem}] 1
