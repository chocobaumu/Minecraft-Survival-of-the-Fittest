...
item replace block ~ ~ ~ container.11 with enchanted_book[item_name='{"text":"クラゲのジェル"}',rarity=common,item_model="survivalotfittest:jellyfish_gel",custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with mushroom_stew[item_name='{"italic":false,"text":"キノコのゼリースープ"}',lore=['{"color":"gray","italic":false,"text":"この奇怪なスープは、キノコとジェルの"}','{"color":"gray","italic":false,"text":"絶妙なバランスによってその効果が保たれる。"}','" "','{"color":"yellow","italic":false,"text":"2分間、忍耐力を30向上させます。"}'],rarity="common",item_model="survivalotfittest:mushroom_jelly_soup",custom_data={SotF:GUIItem},food={nutrition:1,saturation:1,using_converts_to:{id:"minecraft:bowl",count:1}}] 1
