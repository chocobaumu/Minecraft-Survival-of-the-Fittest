...
item replace block ~ ~ ~ container.2 with recovery_compass[custom_data={SotF:GUIItem},item_model="survivalotfittest:corrupt_crystal",rarity="uncommon",item_name='"汚染晶"'] 1
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with recovery_compass[custom_data={SotF:GUIItem},item_model="survivalotfittest:corrupt_crystal",rarity="uncommon",item_name='"汚染晶"'] 1
item replace block ~ ~ ~ container.11 with glass_bottle[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with recovery_compass[custom_data={SotF:GUIItem},item_model="survivalotfittest:corrupt_crystal",rarity="uncommon",item_name='"汚染晶"'] 1
item replace block ~ ~ ~ container.19 with air
item replace block ~ ~ ~ container.20 with recovery_compass[custom_data={SotF:GUIItem},item_model="survivalotfittest:corrupt_crystal",rarity="uncommon",item_name='"汚染晶"'] 1
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with warped_fungus_on_a_stick[max_stack_size=16,item_name='"汚染晶入り瓶"',lore=['{"color":"gray","italic":false,"text":"周囲のスカルクを死滅させます。"}'],item_model="survivalotfittest:sculk_killer",custom_data={SotF:GUIItem},rarity="uncommon",!max_damage] 1
