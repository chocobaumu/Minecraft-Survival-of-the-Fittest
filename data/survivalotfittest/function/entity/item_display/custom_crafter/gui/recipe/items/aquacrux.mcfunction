...
item replace block ~ ~ ~ container.2 with recovery_compass[item_model="survivalotfittest:water_ingot",item_name='"アクアチウムインゴット"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with recovery_compass[item_model="survivalotfittest:water_ingot",item_name='"アクアチウムインゴット"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with recovery_compass[item_model="survivalotfittest:water_ingot",item_name='"アクアチウムインゴット"',rarity="rare",custom_data={SotF:GUIItem}] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:aquacrux",item_name='"水聖十字"',rarity="epic",custom_data={SotF:GUIItem},lore=['{"color":"dark_gray","italic":true,"text":"私（.w.）のお守り。"}']] 1
