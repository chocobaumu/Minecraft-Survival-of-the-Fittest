...
item replace block ~ ~ ~ container.10 with copper_ingot[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with iron_axe[item_name="銅の斧",item_model="survivalotfittest:copper_axe",custom_data={SotF:GUIItem}] 1
