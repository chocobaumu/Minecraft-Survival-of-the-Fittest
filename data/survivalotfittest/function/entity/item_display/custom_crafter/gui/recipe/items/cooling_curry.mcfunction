...
item replace block ~ ~ ~ container.2 with short_grass[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with cooked_beef[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with honey_bottle[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with carrot[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with mushroom_stew[max_stack_size=2,item_name='{"italic":false,"text":"クーリングカレー"}',lore=['{"color":"gray","italic":false,"text":"スパイスを多く含むこのカレーは、"}','{"color":"gray","italic":false,"text":"代謝を助け貴方を暑さから守る力がある。"}','" "','{"color":"yellow","italic":false,"text":"8分間、暑さ耐性を30向上させます。"}'],rarity="common",item_model="survivalotfittest:cooling_curry",custom_data={SotF:GUIItem}] 1
