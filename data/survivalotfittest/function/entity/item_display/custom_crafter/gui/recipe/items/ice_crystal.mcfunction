...
# 完成品部分
item replace block ~ ~ ~ container.16 with warped_fungus_on_a_stick[max_stack_size=64,!max_damage,item_name={"italic":false,"text":"アイスクリスタル"},lore=[{"color":"gray","italic":false,"text":"フリーズロッドから作られた冷たい結晶。"}," ",{"color":"yellow","italic":false,"text":"2分間、温度を15℃低下させます。"}],rarity="common",item_model="survivalotfittest:ice_crystal",custom_data={SotF:GUIItem}] 2
