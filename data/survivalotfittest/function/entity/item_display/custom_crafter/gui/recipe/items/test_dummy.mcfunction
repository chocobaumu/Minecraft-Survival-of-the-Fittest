...
item replace block ~ ~ ~ container.2 with oak_planks[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with stick[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with armor_stand[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with stick[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with air
item replace block ~ ~ ~ container.20 with oak_slab[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with ghast_spawn_egg[item_model="survivalotfittest:test_dummy",item_name='"ダミー"',rarity="common",lore=['{"color":"gray","italic":false,"text":"設置し、攻撃するとダメージを表示します。"}','{"color":"gray","italic":false,"text":"一定時間攻撃をやめると、DPSを表示します。"}','{"color":"gray","italic":false,"text":"設置後、スニークで撤去することができます。"}'],custom_data={SotF:GUIItem}] 1
