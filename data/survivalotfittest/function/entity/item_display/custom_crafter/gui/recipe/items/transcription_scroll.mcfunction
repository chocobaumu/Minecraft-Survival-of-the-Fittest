# レシピ部分
item replace block ~ ~ ~ container.1 with gold_nugget[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.2 with experience_bottle[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.3 with feather[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.10 with amethyst_shard[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with paper[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with glow_ink_sac[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.19 with string[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.20 with amethyst_shard[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.21 with gold_nugget[custom_data={SotF:GUIItem}] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with warped_fungus_on_a_stick[item_name="転写スクロール",item_model="survivalotfittest:transcription_scroll",rarity="uncommon",lore=[{"color":"gray","italic":false,"text":"オフハンドのアイテムを転写します。"},[{"color":"gray","italic":false,"text":"転写可能: "},{"color":"green","italic":false,"text":"スキルスクロール、魔術のスクロール"}]],custom_data={SotF:GUIItem},max_stack_size=1] 1
