...
item replace block ~ ~ ~ container.10 with crying_obsidian[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with leather_boots[dyed_color=5177423,tooltip_display={hidden_components:["dyed_color","trim"]},trim={material:"minecraft:netherite",pattern:"minecraft:silence"},item_name="黒曜石のブーツ",rarity="common",custom_data={SotF:GUIItem},max_damage=722,repairable={items:"obsidian"},attribute_modifiers=[{id:"feet.armor",type:"armor",amount:6,operation:"add_value",slot:"feet"},{id:"feet.armor_toughness",type:"armor_toughness",amount:6,operation:"add_value",slot:"feet"},{id:"feet.max_health",type:"max_health",amount:4,operation:"add_value",slot:"feet"}]] 1
