...
item replace block ~ ~ ~ container.11 with diamond_sword[item_name='{"color":"light_purple","italic":false,"text":"スピア"}',item_model="survivalotfittest:spear",custom_data={SotF:GUIItem},!attribute_modifiers] 1
...
item replace block ~ ~ ~ container.16 with leather_helmet[dyed_color={rgb:5177423,show_in_tooltip:false},trim={material:"minecraft:netherite",pattern:"minecraft:silence",show_in_tooltip:false},item_name='"黒曜石のヘルメット"',rarity="common",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.17 with leather_chestplate[dyed_color={rgb:5177423,show_in_tooltip:false},trim={material:"minecraft:netherite",pattern:"minecraft:silence",show_in_tooltip:false},item_name='"黒曜石のチェストプレート"',rarity="common",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.19 with leather_leggings[dyed_color={rgb:5177423,show_in_tooltip:false},trim={material:"minecraft:netherite",pattern:"minecraft:silence",show_in_tooltip:false},item_name='"黒曜石のレギンス"',rarity="common",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.20 with leather_boots[dyed_color={rgb:5177423,show_in_tooltip:false},trim={material:"minecraft:netherite",pattern:"minecraft:silence",show_in_tooltip:false},item_name='"黒曜石のブーツ"',rarity="common",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.21 with iron_sword[item_model="survivalotfittest:rapier",item_name='"レイピア"',rarity="common",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.22 with iron_axe[item_name='"銅の斧"',item_model="survivalotfittest:copper_axe",custom_data={SotF:GUIItem},!attribute_modifiers] 1
...
item replace block ~ ~ ~ container.24 with iron_pickaxe[item_name='"銅のツルハシ"',item_model="survivalotfittest:copper_pickaxe",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.25 with iron_shovel[item_name='"銅のシャベル"',item_model="survivalotfittest:copper_shovel",custom_data={SotF:GUIItem},!attribute_modifiers] 1
item replace block ~ ~ ~ container.26 with iron_sword[item_name='"銅の剣"',item_model="survivalotfittest:copper_sword",custom_data={SotF:GUIItem},!attribute_modifiers] 1