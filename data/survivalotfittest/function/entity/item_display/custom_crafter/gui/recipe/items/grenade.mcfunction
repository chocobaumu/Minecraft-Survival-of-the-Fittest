...
item replace block ~ ~ ~ container.2 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with tripwire_hook[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with gunpowder[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with air
item replace block ~ ~ ~ container.20 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with snowball[max_stack_size=16,item_name='{"italic":false,"text":"グレネード"}',rarity="common",item_model="survivalotfittest:grenade",custom_data={SotF:GUIItem},hide_additional_tooltip={}] 1
