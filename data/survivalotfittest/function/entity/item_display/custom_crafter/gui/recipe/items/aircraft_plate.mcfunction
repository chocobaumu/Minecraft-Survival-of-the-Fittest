...
item replace block ~ ~ ~ container.2 with recovery_compass[item_name="超硬質プレート",item_model="survivalotfittest:reinforced_hardened_plate",custom_data={SotF:GUIItem},rarity="uncommon"] 1
...
item replace block ~ ~ ~ container.11 with honeycomb[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with recovery_compass[item_name="超硬質プレート",item_model="survivalotfittest:reinforced_hardened_plate",custom_data={SotF:GUIItem},rarity="uncommon"] 1
...
item replace block ~ ~ ~ container.20 with recovery_compass[item_name="超硬質プレート",item_model="survivalotfittest:reinforced_hardened_plate",custom_data={SotF:GUIItem},rarity="uncommon"] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_name="航空機用プレート",item_model="survivalotfittest:aircraft_plate",custom_data={SotF:GUIItem},rarity="uncommon"] 1
