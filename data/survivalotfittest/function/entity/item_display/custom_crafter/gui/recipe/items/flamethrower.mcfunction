...
item replace block ~ ~ ~ container.10 with dispenser[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with recovery_compass[item_name="鋼鉄インゴット",item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:flamethrower/normal",item_name="火炎放射器",custom_data={SotF:GUIItem},lore=[[{"bold":true,"color":"gold","italic":false,"text":"射撃"},{"bold":false,"color":"gray","italic":false,"text":"(右クリック)"}],[{"color":"gray","italic":false,"text":"燃料を"},{"color":"green","italic":false,"text":"1"},{"color":"gray","italic":false,"text":"消費し炎を放つ。炎は対象に"},{"color":"red","italic":false,"text":"1"},{"color":"gray","italic":false,"text":"ダメージを"}],{"color":"gray","italic":false,"text":"与え、炎上させる。"},[{"color":"dark_gray","italic":false,"text":"コスト:"},{"color":"yellow","italic":false,"text":" 燃料×1"}]," ",[{"bold":true,"color":"gold","italic":false,"text":"充填"},{"bold":false,"color":"dark_gray","italic":false,"text":"(Fキー)"}],[{"color":"gray","italic":false,"text":"ガソリンを"},{"color":"green","italic":false,"text":"1"},{"color":"gray","italic":false,"text":"つ消費し燃料を"},{"color":"green","italic":false,"text":"100"},{"color":"gray","italic":false,"text":"回復する。"}],[{"color":"dark_gray","italic":false,"text":"コスト:"},{"color":"red","italic":false,"text":" ガソリン×1"}]," ",{"bold":false,"color":"dark_gray","italic":true,"text":"テクスチャの使いまわしだって？！"}],rarity="common",consumable={consume_seconds:2147483647},max_stack_size=1] 1
