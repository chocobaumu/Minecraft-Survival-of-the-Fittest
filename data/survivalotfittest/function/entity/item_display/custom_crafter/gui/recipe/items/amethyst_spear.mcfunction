...
item replace block ~ ~ ~ container.3 with amethyst_shard[custom_data={SotF:GUIItem}]
...
item replace block ~ ~ ~ container.19 with stick[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.20 with air
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:amethyst_spear",item_name='"アメジストの槍"',rarity="common",lore=['" "','{"color":"gray","italic":false,"text":"利き手に持ったとき："}','{"color":"dark_green","italic":false,"text":" 6 攻撃力"}','{"color":"dark_green","italic":false,"text":" 1.1 攻撃速度"}'],custom_data={SotF:GUIItem},max_stack_size=1] 1
