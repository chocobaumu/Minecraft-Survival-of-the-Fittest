# レシピ部分
item replace block ~ ~ ~ container.1 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.2 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.3 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.10 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with glass_bottle[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.19 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.20 with wind_charge[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.21 with wind_charge[custom_data={SotF:GUIItem}] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with warped_fungus_on_a_stick[max_stack_size=16,!max_damage,item_name={"italic":false,"text":"ウィンドチャンバー"},lore=[{"color":"gray","italic":false,"text":"何かに当たるとウィンドチャージ8つ分の風を起こします。"},{"color":"gray","italic":false,"text":"ダメージは発生しません。"}],item_model="survivalotfittest:wind_chamber",custom_data={SotF:GUIItem}] 1
