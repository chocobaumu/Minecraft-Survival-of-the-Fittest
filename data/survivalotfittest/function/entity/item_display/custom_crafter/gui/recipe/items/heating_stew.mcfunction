...
item replace block ~ ~ ~ container.2 with beetroot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with cooked_chicken[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with wheat[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with potato[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with mushroom_stew[max_stack_size=2,item_name={"italic":false,"text":"ヒーティングシチュー"},lore=[{"color":"gray","italic":false,"text":"多くの食材を適切に調理しできるこのシチューは、"},{"color":"gray","italic":false,"text":"代謝を助け貴方を寒さから守る力がある。"}," ",{"color":"yellow","italic":false,"text":"8分間、寒さ耐性を30向上させます。"}],rarity="common",item_model="survivalotfittest:heating_stew",custom_data={SotF:GUIItem}] 1
