# レシピ部分
item replace block ~ ~ ~ container.1 with iron_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.2 with cauldron[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with iron_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with iron_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with blast_furnace[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with iron_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with iron_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.20 with dropper[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with iron_block[custom_data={SotF:GUIItem}]

# 完成品部分
item replace block ~ ~ ~ container.16 with ghast_spawn_egg[item_name={"italic":false,"text":"精油装置"},rarity="common",custom_data={SotF:GUIItem},item_model="survivalotfittest:refinery"] 1
