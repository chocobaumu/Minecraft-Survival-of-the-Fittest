# レシピ部分
item replace block ~ ~ ~ container.1 with copper_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.2 with copper_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with copper_ingot[custom_data={SotF:GUIItem}]
...
item replace block ~ ~ ~ container.20 with stick[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with iron_pickaxe[item_name='"銅のツルハシ"',item_model="survivalotfittest:copper_pickaxe",custom_data={SotF:GUIItem}] 1
