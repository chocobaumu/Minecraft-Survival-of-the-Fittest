# レシピ部分
item replace block ~ ~ ~ container.1 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.2 with coal[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with coal[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with coal[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.20 with coal[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with iron_ingot[custom_data={SotF:GUIItem}]

# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_name='"鋼鉄インゴット"',item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 5
