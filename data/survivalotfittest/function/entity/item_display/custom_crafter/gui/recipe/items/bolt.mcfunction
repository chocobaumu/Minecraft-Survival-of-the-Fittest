...
item replace block ~ ~ ~ container.3 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with iron_nugget[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with stick[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with arrow[item_name='{"italic":false,"text":"ボルト"}',lore=['{"color":"gray","italic":false,"text":"コンパウンドボウで使用したとき、威力が1.5倍になります。"}'],item_model="survivalotfittest:bolt",custom_data={SotF:GUIItem}] 2
