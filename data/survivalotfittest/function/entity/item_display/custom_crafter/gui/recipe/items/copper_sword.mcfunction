...
item replace block ~ ~ ~ container.11 with copper_ingot[custom_data={SotF:GUIItem}]
...
# 完成品部分
item replace block ~ ~ ~ container.16 with iron_sword[item_name='"銅の剣"',item_model="survivalotfittest:copper_sword",custom_data={SotF:GUIItem}] 1
