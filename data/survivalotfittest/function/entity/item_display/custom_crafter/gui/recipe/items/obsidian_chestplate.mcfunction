# レシピ部分
item replace block ~ ~ ~ container.1 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.2 with air
item replace block ~ ~ ~ container.3 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with crying_obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.20 with obsidian[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with obsidian[custom_data={SotF:GUIItem}]

# 完成品部分
item replace block ~ ~ ~ container.16 with leather_chestplate[dyed_color={rgb:5177423,show_in_tooltip:false},trim={material:"minecraft:netherite",pattern:"minecraft:silence",show_in_tooltip:false},item_name='"黒曜石のチェストプレート"',rarity="common",custom_data={SotF:GUIItem},max_damage=888,repairable={items:"obsidian"},attribute_modifiers=[{id:"chest.armor",type:"armor",amount:16,operation:"add_value",slot:"chest"},{id:"chest.armor_toughness",type:"armor_toughness",amount:6,operation:"add_value",slot:"chest"},{id:"chest.max_health",type:"max_health",amount:4,operation:"add_value",slot:"chest"}]] 1
