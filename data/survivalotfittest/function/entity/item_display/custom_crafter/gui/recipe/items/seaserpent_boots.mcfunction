...
# 完成品部分
item replace block ~ ~ ~ container.16 with leather_boots[item_name='"シーサーペントのブーツ"',rarity="uncommon",custom_data={SotF:GUIItem},attribute_modifiers=[{id:"feet.armor",type:"armor",amount:9,operation:"add_value",slot:"feet"},{id:"feet.armor_toughness",type:"armor_toughness",amount:9,operation:"add_value",slot:"feet"},{id:"water_movement_efficiency",type:"water_movement_efficiency",amount:1,operation:"add_value",slot:"feet"}],dyed_color={rgb:1119511,show_in_tooltip:false},trim={material:"minecraft:lapis",pattern:"minecraft:sentry",show_in_tooltip:false},max_damage=234,lore=['" "','[{"bold":true,"color":"gold","italic":false,"text":"海の覇者"},{"bold":false,"color":"dark_gray","italic":false,"text":"(フルセット)"}]','[{"color":"gray","italic":false,"text":"水中にいるとき、"},{"color":"green","italic":false,"text":"採掘速度上昇 I"},{"color":"gray","italic":false,"text":"と"},{"color":"green","italic":false,"text":"攻撃力上昇 I"},{"color":"gray","italic":false,"text":"を得ます。"}]']] 1
