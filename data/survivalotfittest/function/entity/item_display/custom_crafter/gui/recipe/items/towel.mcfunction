# レシピ部分
item replace block ~ ~ ~ container.1 with white_wool[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.2 with string[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.3 with white_wool[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.10 with string[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.11 with white_wool[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.12 with string[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.19 with white_wool[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.20 with string[custom_data={SotF:GUIItem}] 1
item replace block ~ ~ ~ container.21 with white_wool[custom_data={SotF:GUIItem}] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with enchanted_book[max_stack_size=1,item_name={"italic":false,"text":"タオル"},lore=[{"color":"gray","italic":false,"text":"右クリックで身体についた水を拭き取ります。"},{"color":"gray","italic":false,"text":"スニークしながら右クリックすると絞ることができます。"}],rarity="common",item_model="survivalotfittest:towel",custom_data={SotF:GUIItem},enchantment_glint_override=false,food={nutrition:0,saturation:0,can_always_eat:true}] 1
