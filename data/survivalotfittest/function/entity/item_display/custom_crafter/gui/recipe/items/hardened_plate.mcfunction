...
item replace block ~ ~ ~ container.2 with enchanted_book[max_stack_size=64,item_name='"白い真珠"',rarity="common",custom_data={SotF:GUIItem},enchantment_glint_override=false,item_model="survivalotfittest:white_pearl"] 1
item replace block ~ ~ ~ container.3 with recovery_compass[item_name='"鋼鉄インゴット"',item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 1
item replace block ~ ~ ~ container.10 with enchanted_book[max_stack_size=64,item_name='"白い真珠"',rarity="common",custom_data={SotF:GUIItem},enchantment_glint_override=false,item_model="survivalotfittest:white_pearl"] 1
...
item replace block ~ ~ ~ container.12 with enchanted_book[max_stack_size=64,item_name='"白い真珠"',rarity="common",custom_data={SotF:GUIItem},enchantment_glint_override=false,item_model="survivalotfittest:white_pearl"] 1
item replace block ~ ~ ~ container.19 with recovery_compass[item_name='"鋼鉄インゴット"',item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 1
item replace block ~ ~ ~ container.20 with enchanted_book[max_stack_size=64,item_name='"白い真珠"',rarity="common",custom_data={SotF:GUIItem},enchantment_glint_override=false,item_model="survivalotfittest:white_pearl"] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_name='"硬質プレート"',item_model="survivalotfittest:hardened_plate",custom_data={SotF:GUIItem},rarity="common"] 5
