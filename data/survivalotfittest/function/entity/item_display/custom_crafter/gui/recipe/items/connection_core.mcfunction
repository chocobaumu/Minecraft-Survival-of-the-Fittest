# レシピ部分
item replace block ~ ~ ~ container.1 with raw_iron[item_model="survivalotfittest:metal_scraps",item_name='"金属スクラップ"',rarity="common",custom_data={SotF:GUIItem},lore=['{"color":"gray","italic":false,"text":"いつかに存在した魔導機械の一部。熔かして再利用できる。"}']] 1
item replace block ~ ~ ~ container.2 with recovery_compass[item_name='"鋼鉄インゴット"',item_model="survivalotfittest:steel_ingot",custom_data={SotF:GUIItem},rarity="common"] 1
item replace block ~ ~ ~ container.3 with raw_iron[item_model="survivalotfittest:metal_scraps",item_name='"金属スクラップ"',rarity="common",custom_data={SotF:GUIItem},lore=['{"color":"gray","italic":false,"text":"いつかに存在した魔導機械の一部。熔かして再利用できる。"}']] 1
...
item replace block ~ ~ ~ container.11 with diamond[custom_data={SotF:GUIItem}]
...
item replace block ~ ~ ~ container.19 with raw_iron[item_model="survivalotfittest:metal_scraps",item_name='"金属スクラップ"',rarity="common",custom_data={SotF:GUIItem},lore=['{"color":"gray","italic":false,"text":"いつかに存在した魔導機械の一部。熔かして再利用できる。"}']] 1
item replace block ~ ~ ~ container.20 with redstone_block[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with raw_iron[item_model="survivalotfittest:metal_scraps",item_name='"金属スクラップ"',rarity="common",custom_data={SotF:GUIItem},lore=['{"color":"gray","italic":false,"text":"いつかに存在した魔導機械の一部。熔かして再利用できる。"}']] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:connection_core",item_name='{"italic":false,"text":"コネクションコア"}',custom_data={SotF:GUIItem},rarity="uncommon",lore=['{"color":"gray","italic":false,"text":"適切な場所にドロップすると瘴窟へのゲートが生成されます。"}','{"color":"gray","italic":false,"text":"ゲートはコアを破壊することで消すことができます。"}','" "','{"color":"dark_gray","italic":false,"text":"旧多重皇国が、\\"瘴窟\\"に入るために使用したとされるもの。"}','{"color":"dark_gray","italic":false,"text":"試みは失敗に終わったとされるが... 何があったのだろうか？"}'],!max_stack_size] 1
