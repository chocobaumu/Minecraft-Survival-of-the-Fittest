...
item replace block ~ ~ ~ container.3 with spider_eye[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with air
item replace block ~ ~ ~ container.11 with honey_bottle[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with bone_meal[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with air
item replace block ~ ~ ~ container.20 with air
item replace block ~ ~ ~ container.21 with air

# 完成品部分
item replace block ~ ~ ~ container.16 with warped_fungus_on_a_stick[item_name="解毒薬",item_model="survivalotfittest:antidote",custom_data={SotF:GUIItem}] 1
