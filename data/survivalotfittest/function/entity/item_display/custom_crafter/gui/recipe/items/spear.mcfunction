...
item replace block ~ ~ ~ container.2 with heavy_core[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with air
item replace block ~ ~ ~ container.11 with enchanted_book[item_name="フリーズロッド",rarity="common",item_model="survivalotfittest:freeze_rod",custom_data={SotF:GUIItem}] 1
...
# 完成品部分
item replace block ~ ~ ~ container.16 with diamond_sword[item_name="スピア",lore=[" ",{"color":"dark_gray","italic":false,"text":"走って攻撃したとき、攻撃力が上昇します。"}," ",{"color":"gray","italic":false,"text":"利き手に持ったとき："},{"color":"dark_green","italic":false,"text":"攻撃力 +6"},{"color":"dark_green","italic":false,"text":"リーチ +1"},{"color":"dark_green","italic":false,"text":"攻撃速度 1"}],rarity="epic",item_model="survivalotfittest:spear",custom_data={SotF:GUIItem}] 1
