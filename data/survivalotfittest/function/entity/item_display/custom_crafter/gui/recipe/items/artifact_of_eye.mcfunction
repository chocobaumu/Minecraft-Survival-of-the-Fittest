...
item replace block ~ ~ ~ container.2 with enchanted_book[item_name='"???????????????"',lore=['[{"color":"gold","italic":false,"text":"高度な作業台 "},{"color":"dark_gray","italic":false,"text":"で修復可能"}]'],rarity="rare",item_model="survivalotfittest:shattered_artifact_of_eye",custom_data={SotF:GUIItem},enchantment_glint_override=false] 1
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.10 with air
item replace block ~ ~ ~ container.11 with heart_of_the_sea[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.12 with air
item replace block ~ ~ ~ container.19 with enchanted_book[item_name='"???????????????"',lore=['[{"color":"gold","italic":false,"text":"高度な作業台 "},{"color":"dark_gray","italic":false,"text":"で修復可能"}]'],rarity="rare",item_model="survivalotfittest:shattered_artifact_of_eye",custom_data={SotF:GUIItem},enchantment_glint_override=false] 1
item replace block ~ ~ ~ container.20 with air
item replace block ~ ~ ~ container.21 with enchanted_book[item_name='"???????????????"',lore=['[{"color":"gold","italic":false,"text":"高度な作業台 "},{"color":"dark_gray","italic":false,"text":"で修復可能"}]'],rarity="rare",item_model="survivalotfittest:shattered_artifact_of_eye",custom_data={SotF:GUIItem},enchantment_glint_override=false] 1

# 完成品部分
item replace block ~ ~ ~ container.16 with enchanted_book[item_name='"単眼のアーティファクト"',lore=['[{"color":"gray","italic":false,"text":"??"},{"color":"green","italic":false,"text":"????"},{"color":"gray","italic":false,"text":"???????????"}]','{"color":"gray","italic":false,"text":"??????????????"}'],rarity="rare",item_model="survivalotfittest:artifact_of_eye",custom_data={SotF:GUIItem}] 1
