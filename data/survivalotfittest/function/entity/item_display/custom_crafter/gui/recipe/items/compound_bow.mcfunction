...
item replace block ~ ~ ~ container.2 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.3 with piston[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.10 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.11 with air
item replace block ~ ~ ~ container.12 with chain[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.19 with air
item replace block ~ ~ ~ container.20 with iron_ingot[custom_data={SotF:GUIItem}]
item replace block ~ ~ ~ container.21 with piston[custom_data={SotF:GUIItem}]

# 完成品部分
item replace block ~ ~ ~ container.16 with bow[item_name='{"color":"white","italic":false,"text":"コンパウンドボウ"}',item_model="survivalotfittest:compound_bow",custom_data={SotF:GUIItem}] 1
