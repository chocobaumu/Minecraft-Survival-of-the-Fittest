...
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:water_gem",item_name='"アクアチウムジェム"',rarity="rare",custom_data={SotF:WaterGem}] 1