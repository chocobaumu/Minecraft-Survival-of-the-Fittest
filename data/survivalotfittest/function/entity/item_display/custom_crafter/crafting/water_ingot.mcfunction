...
item replace block ~ ~ ~ container.16 with recovery_compass[item_model="survivalotfittest:water_ingot",item_name='"アクアチウムインゴット"',rarity="rare",custom_data={SotF:WaterIngot}] 1