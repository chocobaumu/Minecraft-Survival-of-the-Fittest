...
item replace block ~ ~ ~ container.16 with recovery_compass[item_name='"超硬質プレート"',item_model="survivalotfittest:reinforced_hardened_plate",custom_data={SotF:ReinforcedHardenedPlate},rarity="uncommon"] 5