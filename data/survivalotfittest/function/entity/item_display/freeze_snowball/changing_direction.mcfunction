...
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 1..180 rotated as @s run tp @s ~ ~ ~ ~-5.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches ..-180 rotated as @s run tp @s ~ ~ ~ ~-5.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches -179..0 rotated as @s run tp @s ~ ~ ~ ~5.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 181.. rotated as @s run tp @s ~ ~ ~ ~5.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.1 matches 1.. rotated as @s run tp @s ~ ~ ~ ~ ~-5.5
execute at @s if score @s Choco.SotF.ScoreStorage.1 matches ..-1 rotated as @s run tp @s ~ ~ ~ ~ ~5.5