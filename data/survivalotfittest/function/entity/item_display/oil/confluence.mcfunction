...
#execute if score @s Choco.SotF.ScoreStorage.0 matches 11.. run scoreboard players set @s Choco.SotF.ScoreStorage.0 10
...
#particle soul_fire_flame ~ ~3 ~ 0 0 0 0 10 force
