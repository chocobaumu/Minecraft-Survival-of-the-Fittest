$execute if block ~ ~-1.25 ~ #survivalotfittest:can_through if block ~ ~-0.6125 ~ #survivalotfittest:can_through rotated ~-$(roll) ~ if function survivalotfittest:entity/item_display/aircraft/checking_object/frecciascura run rotate @s ~ ~
...
execute if block ~ ~-1.25 ~ #survivalotfittest:can_through if block ~ ~-0.6125 ~ #survivalotfittest:can_through run scoreboard players remove @s Choco.SotF.ScoreStorage.13 4