...
summon area_effect_cloud ~ ~ ~ {Particle:{type:"dust_pillar",block_state:"minecraft:crying_obsidian"},Radius:3f,RadiusPerTick:2f,Duration:10,potion_contents:{custom_effects:[{id:"minecraft:instant_damage",amplifier:5,duration:2}]}}
