...
item replace block ~ ~ ~ container.1 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.2 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.3 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
...
item replace block ~ ~ ~ container.10 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.11 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.12 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.14 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
...
item replace block ~ ~ ~ container.16 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
...
item replace block ~ ~ ~ container.19 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.20 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
item replace block ~ ~ ~ container.21 with white_stained_glass_pane[hide_tooltip={},custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_default"] 1
...
# 起動/停止
execute if score @s Choco.SotF.ScoreStorage.2 matches 0 run item replace block ~ ~ ~ container.13 with white_stained_glass_pane[item_name='{"text":"停止中","color":"gray"}',custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_refinery_disabled"] 1
execute if score @s Choco.SotF.ScoreStorage.2 matches 1 run item replace block ~ ~ ~ container.13 with white_stained_glass_pane[item_name='{"text":"起動中","color":"gray"}',custom_data={SotF:GUIItem},item_model="survivalotfittest:gui_refinery_enabled"] 1
