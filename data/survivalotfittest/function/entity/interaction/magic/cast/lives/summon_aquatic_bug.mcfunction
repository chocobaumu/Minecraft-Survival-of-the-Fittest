...
execute at @s anchored eyes positioned ^1 ^1 ^-2 run function survivalotfittest:summon/mobs/aquatic_bug
execute at @s anchored eyes positioned ^ ^1.5 ^-3 run function survivalotfittest:summon/mobs/aquatic_bug
execute at @s anchored eyes positioned ^-1 ^1 ^-2 run function survivalotfittest:summon/mobs/aquatic_bug