...
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle soul_fire_flame ^ ^ ^-1 ^ ^ ^100000000 0.000000005 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle poof ^ ^ ^-1 ^ ^ ^100000000 0.000000005 0 force
