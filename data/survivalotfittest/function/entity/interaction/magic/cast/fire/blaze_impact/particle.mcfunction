...
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle flame ^ ^ ^ ^ ^ ^100000000 0.000000005 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle flame ^ ^ ^ ^ ^ ^100000000 0.000000010 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle flame ^ ^ ^ ^ ^ ^100000000 0.000000015 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle large_smoke ^ ^ ^ ^ ^ ^100000000 0.000000005 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle large_smoke ^ ^ ^ ^ ^ ^100000000 0.000000010 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle large_smoke ^ ^ ^ ^ ^ ^100000000 0.000000015 0 force
execute as @e[type=!player,tag=Choco.SotF.Temp] run function survivalotfittest:internal/kill