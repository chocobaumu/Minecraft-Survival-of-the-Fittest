...
execute at @s on vehicle if entity @s[type=item_display,tag=aj.fomalhaut.root] at @s on passengers if entity @s[type=slime,tag=Choco.SotF.Fomalhaut] run summon marker ~ ~ ~ {Tags:["Choco.SotF.Fomalhaut.WaterLocated"]}
