...
execute as @e[type=marker,tag=Choco.SotF.UndeadConjurer.Fang.ChangingDirection,distance=..16] at @s facing entity @n[type=marker,tag=Choco.SotF.Fomalhaut.WaterLocated,distance=..128] feet run rotate @s ~ 0
...
execute if score #Temp Choco.SotF.ScoreStorage.0 matches 370.. on vehicle if entity @s[type=item_display,tag=aj.fomalhaut.root] at @s facing entity @n[type=marker,tag=Choco.SotF.Fomalhaut.WaterLocated,distance=..128] feet run rotate @s ~ 0
execute if score #Temp Choco.SotF.ScoreStorage.0 matches ..-370 on vehicle if entity @s[type=item_display,tag=aj.fomalhaut.root] at @s facing entity @n[type=marker,tag=Choco.SotF.Fomalhaut.WaterLocated,distance=..128] feet run rotate @s ~ 0
