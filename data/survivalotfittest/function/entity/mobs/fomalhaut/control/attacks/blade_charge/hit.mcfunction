...
execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 0 if score @s Choco.SotF.Laceration.Level matches ..2 if score @s Choco.SotF.Data.HurtTime matches 9 run scoreboard players add @s Choco.SotF.Laceration.Level 1
execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 0 if score @s Choco.SotF.Laceration.Tick matches ..199 if score @s Choco.SotF.Data.HurtTime matches 9 run scoreboard players add @s Choco.SotF.Laceration.Tick 60

execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 1 if score @s Choco.SotF.Data.HurtTime matches 9 run scoreboard players add @s Choco.SotF.Laceration.Level 1
execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 1 if score @s Choco.SotF.Data.HurtTime matches 9 run scoreboard players add @s Choco.SotF.Laceration.Tick 60
