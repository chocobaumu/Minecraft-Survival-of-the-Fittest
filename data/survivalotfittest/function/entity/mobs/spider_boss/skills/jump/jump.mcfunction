...
execute rotated as @s run summon area_effect_cloud ~ ~ ~ {Duration:6,Age:4,potion_contents:{custom_effects:[{id:"minecraft:levitation",amplifier:0b,duration:2,show_particles:0b}]}}
