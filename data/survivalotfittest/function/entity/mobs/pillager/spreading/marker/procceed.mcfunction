...
execute at @s positioned ~-1 ~-1 ~-1 as @e[type=pillager,tag=Choco.SotF.Illigers,tag=!Choco.SotF.Temp,dx=2,dy=2,dz=2] run function survivalotfittest:entity/mobs/pillager/spreading/marker/hit
