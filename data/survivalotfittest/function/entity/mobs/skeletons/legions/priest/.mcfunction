...
execute if entity @e[tag=Choco.SotF.SkeletonLegion,tag=!Choco.SotF.SkeletonHealer,tag=!Choco.SotF.SkeletonPriest,distance=..24] if score @s Choco.SotF.tick.2 matches 0 run function survivalotfittest:entity/mobs/skeletons/legions/priest/make_cross