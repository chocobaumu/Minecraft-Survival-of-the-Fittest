execute at @s rotated ~ 0 if block ^ ^ ^-0.2 #survivalotfittest:can_through in overworld positioned 0.0 0.0 0.0 run summon marker ^0.75 ^0.375 ^-0.75 {Tags:["Choco.SotF.PgilinPotion_Direction"]}
