execute at @s if entity @e[tag=Choco.SotF.Enemies_Target,distance=..16] run function survivalotfittest:entity/mobs/place_block/ {"block":"end_stone_bricks","target":"Choco.SotF.Enemies_Target"}
