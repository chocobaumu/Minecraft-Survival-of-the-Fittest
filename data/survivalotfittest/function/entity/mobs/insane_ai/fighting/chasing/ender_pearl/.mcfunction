...
execute at @s facing entity @n[tag=Choco.SotF.InsaneAI.Target] feet in overworld positioned 0.0 0.0 0.0 run summon marker ^ ^0.125 ^1.25 {Tags:["Choco.SotF.PgilinPotion_Direction"]}
...
scoreboard players set @s Choco.SotF.tick.1 300
