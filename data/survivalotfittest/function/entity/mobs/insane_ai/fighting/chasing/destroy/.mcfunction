...
execute if score @s Choco.SotF.Data.OnGround matches 1 run function survivalotfittest:entity/mobs/insane_ai/fighting/chasing/destroy/succeed {"target":"Choco.SotF.InsaneAI.Target"}