...
#橋かける
execute if entity @s[predicate=survivalotfittest:stand_still] if score @s Choco.SotF.FallFlying matches 0 if score @s Choco.SotF.Pos.1 matches 0 if score @s Choco.SotF.Data.OnGround matches 1 facing entity @n[tag=Choco.SotF.InsaneAI.Target] feet rotated ~ 0 positioned ^ ^-1 ^1 if block ~ ~ ~ #survivalotfittest:can_through if block ~ ~-1 ~ #survivalotfittest:can_through run function survivalotfittest:summon/misc/placed_block {"block":"cobblestone"}
execute if score @s Choco.SotF.Pos.1 matches 0 if score @s Choco.SotF.Data.HurtTime matches ..7 at @s if score @s Choco.SotF.Data.OnGround matches 1 facing entity @n[tag=Choco.SotF.InsaneAI.Target] feet rotated ~ 0 unless block ^ ^-1 ^1 #survivalotfittest:can_through if block ^ ^-1 ^2 #survivalotfittest:can_through run function survivalotfittest:entity/mobs/insane_ai/fighting/chasing/placement/chasing