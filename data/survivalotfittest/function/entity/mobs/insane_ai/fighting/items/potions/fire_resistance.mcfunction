...
execute if score @s Choco.SotF.tick.8 matches 4 run item replace entity @s weapon.mainhand with potion[potion_contents={potion:"fire_resistance"}]
...
execute if score @s Choco.SotF.tick.8 matches 28.. run effect give @s fire_resistance 180 0
