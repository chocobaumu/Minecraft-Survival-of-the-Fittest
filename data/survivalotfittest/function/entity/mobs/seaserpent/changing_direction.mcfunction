...
execute as @e[type=marker,tag=Choco.SotF.UndeadConjurer.Fang.ChangingDirection] at @s run rotate @s facing entity @e[tag=Choco.SotF.Seaserpent_Eats,sort=nearest,limit=1] feet
...
execute if score @s Choco.SotF.ScoreStorage.0 matches 370.. run rotate @s facing entity @n[tag=Choco.SotF.Seaserpent_Eats] feet
execute if score @s Choco.SotF.ScoreStorage.0 matches ..-370 run rotate @s facing entity @n[tag=Choco.SotF.Seaserpent_Eats] feet

execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 1..180 rotated as @s run rotate @s ~-3 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches ..-180 rotated as @s run rotate @s ~-3 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches -179..0 rotated as @s run rotate @s ~3 ~
execute at @s if score @s Choco.SotF.ScoreStorage.0 matches 181.. rotated as @s run rotate @s ~3 ~
