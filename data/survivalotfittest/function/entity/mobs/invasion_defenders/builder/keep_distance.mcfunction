execute as @s facing entity @n[type=item_display,tag=Choco.SotF.InvasionFlag] feet run rotate @s ~180 ~

execute rotated as @s rotated ~ 0 if block ^ ^ ^0.25 #survivalotfittest:can_through in overworld positioned 0.0 0.0 0.0 run summon marker ^ ^ ^0.25 {Tags:["Choco.SotF.PgilinPotion_Direction"]}
