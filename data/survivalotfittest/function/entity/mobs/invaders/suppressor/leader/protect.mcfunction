execute as @n[type=marker,tag=Choco.SotF.Invasion.FrontLine,tag=Choco.SotF.Invasion.Protected] store result score #Invasion.FrontLine.Pos Choco.SotF.Pos.1 run data get entity @s Pos[1]
scoreboard players operation @s Choco.SotF.Pos.1 -= #Invasion.FrontLine.Pos Choco.SotF.Pos.1

execute as @s facing entity @n[type=marker,tag=Choco.SotF.Invasion.FrontLine,tag=Choco.SotF.Invasion.Protected] feet run rotate @s ~ ~
