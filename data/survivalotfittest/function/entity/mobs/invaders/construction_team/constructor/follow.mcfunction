execute as @n[tag=Choco.SotF.Invasion.ConstructorLeader] store result score #Invasion.FrontLine.Pos Choco.SotF.Pos.1 run data get entity @s Pos[1]
scoreboard players operation @s Choco.SotF.Pos.1 -= #Invasion.FrontLine.Pos Choco.SotF.Pos.1

execute as @s facing entity @n[tag=Choco.SotF.Invasion.ConstructorLeader] feet run rotate @s ~ ~
