...
execute anchored eyes positioned ^ ^ ^0.75 rotated ~ 0 positioned ^ ^-1 ^ as @n[tag=Choco.SotF.Zombie_Target,distance=..1] at @s run rotate @s facing entity @n[type=zombie,tag=Choco.SotF.Invasion.ConstructorGuard]

execute if score @s Choco.SotF.tick.2 matches 300 run function survivalotfittest:entity/mobs/invaders/construction_team/guard/melee/kick
