...
execute if score @s Choco.SotF.tick.2 matches 0 positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=!Choco.SotF.AbyssalJellyfish,dy=1,tag=Choco.SotF.Mobs] run function survivalotfittest:entity/mobs/jellyfish/attack

particle glow ~ ~0.85 ~ 0.25 0.55 0.25 0.1 1 normal
