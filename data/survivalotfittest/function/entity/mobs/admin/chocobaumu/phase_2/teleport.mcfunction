...
scoreboard players set @s Choco.SotF.tick.7 1260

execute store result score #Chocobaumu Choco.SotF.Random run random value 1..4
execute if score #Chocobaumu Choco.SotF.Random matches 1..3 run scoreboard players set @s Choco.SotF.tick.7 1450