...
# > 剣(P1グリモアと同じ)
execute if score @s Choco.SotF.tick.7 matches 900.. run scoreboard players add @s Choco.SotF.tick.8 1
execute if score @s Choco.SotF.tick.7 matches 900.. if score @s Choco.SotF.tick.8 matches 100.. run function survivalotfittest:entity/mobs/admin/chocobaumu/items/grimoire/random_sword

# > 分身
execute if score @s Choco.SotF.tick.7 matches 900.. run scoreboard players add @s Choco.SotF.tick.9 1
execute if score @s Choco.SotF.tick.7 matches 900.. if score @s Choco.SotF.tick.9 matches 700.. run function survivalotfittest:entity/mobs/admin/chocobaumu/phase_2/imagine