execute store result score @s Choco.SotF.ScoreStorage.5 run random value 1..9
...
execute if score @s Choco.SotF.ScoreStorage.5 matches 7 run function survivalotfittest:entity/mobs/admin/chocobaumu/random_skill/crystal
execute if score @s Choco.SotF.ScoreStorage.5 matches 8 run function survivalotfittest:entity/mobs/admin/chocobaumu/random_skill/cursing_sword
execute if score @s Choco.SotF.ScoreStorage.5 matches 9 run function survivalotfittest:entity/mobs/admin/chocobaumu/random_skill/cursing_sword_large