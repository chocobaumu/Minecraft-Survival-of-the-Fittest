...
execute if score @s Choco.SotF.ScoreStorage.1 matches 600.. run scoreboard players set @s Choco.SotF.ScoreStorage.1 0
...
execute if score @s Choco.SotF.ScoreStorage.1 matches 10 run item replace entity @s weapon.mainhand with golden_sword
