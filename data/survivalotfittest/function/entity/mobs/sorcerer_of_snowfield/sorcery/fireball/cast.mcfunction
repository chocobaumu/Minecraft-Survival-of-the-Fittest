...
execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 0 anchored eyes run summon small_fireball ^-0.625 ^-0.325 ^1.1 {Tags:["Choco.SotF.Magic","Choco.SotF.Magic.FireBall","Choco.SotF.Temp"]}
...
#* ナイトメア
execute if score #HardeMode Choco.SotF.ScoreStorage.0 matches 1 run function survivalotfittest:entity/mobs/sorcerer_of_snowfield/sorcery/fireball/nightmare