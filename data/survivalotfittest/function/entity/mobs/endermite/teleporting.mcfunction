...
execute store result score @s Choco.SotF.Endermites_Teleport.0 run random value -8..8
...
execute store result score @s Choco.SotF.Endermites_Teleport.1 run random value -8..8
...
execute store result score @s Choco.SotF.Endermites_Teleport.2 run random value -8..8
