summon area_effect_cloud ~ ~ ~ {WaitTime:0,custom_particle:{type:"damage_indicator"},Radius:1f,RadiusPerTick:1.5f,Duration:10,Age:0,potion_contents:{custom_effects:[{id:"minecraft:wither",amplifier:9,duration:200,ambient:1b},{id:"minecraft:instant_damage",amplifier:1,duration:1,ambient:1b},{id:"minecraft:blindness",amplifier:0,duration:100,ambient:1b},{id:"minecraft:darkness",amplifier:0,duration:100,ambient:1b}]}}
