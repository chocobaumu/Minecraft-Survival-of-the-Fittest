...
execute as @e[type=marker,tag=Choco.SotF.UndeadConjurer.Fang.ChangingDirection] at @s run rotate @s facing entity @e[tag=Choco.SotF.Target,sort=nearest,limit=1] feet
...
execute if score @s Choco.SotF.ScoreStorage.2 matches ..-370 run rotate @s facing entity @n[tag=Choco.SotF.Target] feet
execute if score @s Choco.SotF.ScoreStorage.2 matches 370.. run scoreboard players set @s Choco.SotF.tick.1 80
execute if score @s Choco.SotF.ScoreStorage.2 matches ..-370 run scoreboard players set @s Choco.SotF.tick.1 80

execute at @s if score @s Choco.SotF.ScoreStorage.2 matches 1..180 rotated as @s run rotate @s ~-4.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.2 matches ..-180 rotated as @s run rotate @s ~-4.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.2 matches -179..0 rotated as @s run rotate @s ~4.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.2 matches 181.. rotated as @s run rotate @s ~4.5 ~
execute at @s if score @s Choco.SotF.ScoreStorage.1 matches 1.. rotated as @s run rotate @s ~ ~-4.5
execute at @s if score @s Choco.SotF.ScoreStorage.1 matches ..-1 rotated as @s run rotate @s ~ ~4.5