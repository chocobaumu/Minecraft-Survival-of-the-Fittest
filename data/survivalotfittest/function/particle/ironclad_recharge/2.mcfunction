...
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle minecraft:crit ^ ^ ^ ^ ^ ^-1000000000 0.000000001 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle minecraft:crit ^ ^ ^ ^ ^ ^-1000000000 0.000000002 0 force
execute as @e[type=marker,tag=Choco.SotF.Particle,tag=Choco.SotF.Temp] at @s facing entity @n[type=marker,tag=Choco.SotF.Origin,tag=Choco.SotF.Temp] feet run particle minecraft:crit ^ ^ ^ ^ ^ ^-1000000000 0.000000004 0 force
