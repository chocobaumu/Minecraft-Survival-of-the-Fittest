...
tag @s[type=piglin,nbt={equipment:{mainhand:{id:"minecraft:crossbow"}}}] add Choco.SotF.Type_Range
tag @s[type=piglin,nbt={equipment:{mainhand:{id:"minecraft:golden_sword"}}}] add Choco.SotF.Type_Melee
