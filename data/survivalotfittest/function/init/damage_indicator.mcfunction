...
execute if score @s Choco.SotF.Math matches 0 run data merge entity @s {billboard:"center",teleport_duration:2,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:'{"score":{"name":"@s","objective":"Choco.SotF.DamageIndicator.Health_Before"},"color":"red","bold":true,"italic":false}',background:16711680}
execute if score @s Choco.SotF.Math matches 1 run data merge entity @s {billboard:"center",teleport_duration:2,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]},text:'{"score":{"name":"@s","objective":"Choco.SotF.DamageIndicator.Health_Before"},"color":"green","bold":true,"italic":false}',background:16711680}